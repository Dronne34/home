...
plugins=(git gh man fzf history archlinux colorize zsh-autosuggestions zsh-syntax-highlighting colored-man-pages)
...
export LESS_TERMCAP_me=$'\e[1;36m'
export LESS_TERMCAP_se=$'\e[1;37m'
